...
import com.detallsublim.app.repository.AuthorityRepository;
...
class AccountResourceIT {
    ...
    @Test
    @WithUnauthenticatedMockUser
    void testRegisterIsDisabledForAnonymousUsers() throws Exception {
        restAccountMockMvc
            .perform(post("/api/register").contentType(MediaType.APPLICATION_JSON).content("{}"))
            .andExpect(status().isUnauthorized());
    }

    @Test
    @WithMockUser
    void testRegisterIsDisabledForAuthenticatedUsers() throws Exception {
        restAccountMockMvc
            .perform(post("/api/register").contentType(MediaType.APPLICATION_JSON).content("{}"))
    ...
    @Test
    @WithUnauthenticatedMockUser
    void testActivationIsDisabledForAnonymousUsers() throws Exception {
        restAccountMockMvc.perform(get("/api/activate").param("key", "test-key")).andExpect(status().isUnauthorized());
    }

    @Test
    @WithMockUser
    void testActivationIsDisabledForAuthenticatedUsers() throws Exception {
        restAccountMockMvc.perform(get("/api/activate").param("key", "test-key")).andExpect(status().isForbidden());
    }
